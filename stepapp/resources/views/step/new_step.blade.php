...
<!--ーーーーーーーーーーーーーーーーーー STEP投稿画面表示 ーーーーーーーーーーーーーーーーーー--> 
    <div class="l-bg p-stepForm"> 
      ...
      <form class="p-newStep">
      @csrf
        <p class="p-newStep__heading">タイトル</p>
        <input type="text" name="title" class="p-newStep__title" placeholder="STEP名" />
        <span class="c-invalid p-titleMsg" role="alert">
          <strong>30文字以内で入力して下さい</strong>
        </span>

　　　　　<p class="p-newStep__heading">内容</p>
         <textarea
          class="p-newStep__content" name="content"　cols="30"　rows="10" placeholder="内容"
        ></textarea>
        <span class="c-invalid p-contentMsg" role="alert">
          <strong>1万文字以内</strong>
        </span>

        <p class="p-newStep__heading">画像</p>
        ...
        <p class="p-newStep__heading">カテゴリー</p>
        <select name="category_id" class="p-newStep__category">
        ...
        <p class="p-newStep__heading">目標時間(単位：時間)</p>
        <div class="p-newStep__time">
          <input
            type="number"
            name="time"
            class="p-stepTime"

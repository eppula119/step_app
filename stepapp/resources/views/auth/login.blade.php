...
<body>
<div id="app">
<!--ーーーーーーーーーーーーーーーーーーーーーー ヘッダー ーーーーーーーーーーーーーーーーーーーー-->
...
<!--ーーーーーーーーーーーーーーーーーーーーーー login画面　ーーーーーーーーーーーーーーーーーーーー-->
  <main class="l-main">
    ...
    <div class="l-bg p-authForm"> 
      <div class="p-authForm__container">
        ...
        <form method="post"  class="c-form">
          ...
          <input type="password" name="password" class="c-form__input"　required autocomplete="current-password" placeholder="※7文字以上半角英数字">
